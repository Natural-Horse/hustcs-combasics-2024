...
bomb1:     file format elf64-x86-64
...
0000000000001130 <deregister_tm_clones>:
    ...
    1137:	48 8d 05 12 2f 00 00 	lea    0x2f12(%rip),%rax        # 4050 <__TMC_END__>
...
0000000000001160 <register_tm_clones>:
    1160:	48 8d 3d e9 2e 00 00 	lea    0x2ee9(%rip),%rdi        # 4050 <__TMC_END__>
    1167:	48 8d 35 e2 2e 00 00 	lea    0x2ee2(%rip),%rsi        # 4050 <__TMC_END__>
...
00000000000011a0 <__do_global_dtors_aux>:
    ...
    11a4:	80 3d a5 2e 00 00 00 	cmpb   $0x0,0x2ea5(%rip)        # 4050 <__TMC_END__>
    ...
    11cc:	c6 05 7d 2e 00 00 01 	movb   $0x1,0x2e7d(%rip)        # 4050 <__TMC_END__>
    11d3:	5d                   	pop    %rbp
    11d4:	c3                   	ret    
...
00000000000012b6 <main>:
    ...
    1316:	48 8b 05 2b 2d 00 00 	mov    0x2d2b(%rip),%rax        # 4048 <phase>
    131d:	48 85 c0             	test   %rax,%rax
    1320:	74 10                	je     1332 <main+0x7c>
    1322:	48 8b 15 1f 2d 00 00 	mov    0x2d1f(%rip),%rdx        # 4048 <phase>
...
0000000000001398 <do_phase>:
    ...
    13aa:	48 98                	cltq   
    13ac:	48 8d 15 6d 2c 00 00 	lea    0x2c6d(%rip),%rdx        # 4020 <buf>
    13b3:	48 01 d0             	add    %rdx,%rax
    13b6:	48 89 c6             	mov    %rax,%rsi
    13b9:	48 8d 3d 57 0d 00 00 	lea    0xd57(%rip),%rdi        # 2117 <_IO_stdin_used+0x117>
    13c0:	b8 00 00 00 00       	mov    $0x0,%eax
    13c5:	e8 06 fd ff ff       	call   10d0 <printf@plt>
    13ca:	90                   	nop
    13cb:	c9                   	leave  
    13cc:	c3                   	ret    
