...
bomb6:     file format elf64-x86-64
...
0000000000401385 <do_phase>:
  ...
  401394:	48 8b 05 24 00 00 00 	mov    0x24(%rip),%rax        # 4013bf <myprint>
  40139b:	48 85 c0             	test   %rax,%rax
  40139e:	74 10                	je     4013b0 <do_phase+0x2b>
  4013a0:	48 8b 15 18 00 00 00 	mov    0x18(%rip),%rdx        # 4013bf <myprint>
