...
bomb2:     file format elf64-x86-64
...
0000000000001398 <myfunc>:
    ...
    13a0:	48 8d 3d 70 0d 00 00 	lea    0xd70(%rip),%rdi        # 2117 <_IO_stdin_used+0x117>
    13a7:	e8 f4 fc ff ff       	call   10a0 <puts@plt>
    13ac:	90                   	nop
    13ad:	5d                   	pop    %rbp
    13ae:	c3                   	ret    

00000000000013af <do_phase>:
    ...
    13c3:	e8 d0 ff ff ff       	call   1398 <myfunc>
    13c8:	90                   	nop
    13c9:	90                   	nop
    13ca:	90                   	nop
    13cb:	90                   	nop
