...
fabbomb2:     file format elf64-x86-64
...
00000000004011a0 <__do_global_dtors_aux>:
  ...
  4011a4:	80 3d b5 2e 00 00 00 	cmpb   $0x0,0x2eb5(%rip)        # 404060 <__TMC_END__>
  ...
  4011b6:	c6 05 a3 2e 00 00 01 	movb   $0x1,0x2ea3(%rip)        # 404060 <__TMC_END__>
  4011bd:	5d                   	pop    %rbp
  4011be:	c3                   	ret    
  4011bf:	90                   	nop
  4011c0:	c3                   	ret    
...
0000000000401385 <myfunc>:
  401385:	f3 0f 1e fa          	endbr64 
  401389:	55                   	push   %rbp
  40138a:	48 89 e5             	mov    %rsp,%rbp
  40138d:	48 8d 05 83 0d 00 00 	lea    0xd83(%rip),%rax        # 402117 <_IO_stdin_used+0x117>
  401394:	48 89 c7             	mov    %rax,%rdi
  401397:	e8 f4 fc ff ff       	call   401090 <puts@plt>
  40139c:	90                   	nop
  40139d:	5d                   	pop    %rbp
  40139e:	c3                   	ret    

000000000040139f <do_phase>:
  40139f:	f3 0f 1e fa          	endbr64 
  4013a3:	55                   	push   %rbp
  4013a4:	48 89 e5             	mov    %rsp,%rbp
  4013a7:	48 83 ec 10          	sub    $0x10,%rsp
  4013ab:	89 7d fc             	mov    %edi,-0x4(%rbp)
  4013ae:	b8 00 00 00 00       	mov    $0x0,%eax
  4013b3:	e8 cd ff ff ff       	call   401385 <myfunc>
  4013b8:	90                   	nop
  4013b9:	90                   	nop
  4013ba:	90                   	nop
  4013bb:	90                   	nop
